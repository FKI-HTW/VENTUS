...
namespace VENTUS.Controlling
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        void OnCancelTeleport(InputAction.CallbackContext context)
        {
            ...
            // OnAfterInterinteractionEvents will handle deactivating its GameObject.
        ...
        protected void Awake()
        {
            ...
            // StartCoroutine(OnAfterInterinteractionEvents());
        }
        ...
        IEnumerator OnAfterInterinteractionEvents()
        {
